...
$$ Level~1:~~~{y_{ij} = \beta_{0j} + \beta_{1j}(time_{ij}) + \beta_{xj}*(X) + e_{ij}}~~~ (1.1)$$


$$ Level~2~Intercept:~~~{\beta_{0j} = \gamma_{00} + \gamma_{0j}*(Q) + u_{0j}} ~~~ (1.2)$$
$$ Level~2~Slope:~~~{\beta_{1j} = \gamma_{10} + \gamma_{11}*(Private_{j}) + u_{1j}} ~~~ (1.2)$$

$$ Level~2~Slope:~~~{\beta_{xj} = \gamma_{x0} + u_{xj}} ~~~ (1.3)$$
$$Mixed~model: ~~~{y_{ij} = \gamma_{00}+\gamma_{11}(Time_{ij})*(Private_{j}) + \gamma_{x0}*(X)+ \gamma_{0j}*(Q) + u_{1j}} + u_{xj} + u_{0j} + e_{ij}} ~~~(1.4)$$
