...
```
Here I need to add the repeats for the fixed values.  Here is for the first data set.
...
+X1_CHSEX_R + X1_HISP_R +X1_BLACK_R+X1_ASIAN_R+X1_AMINAN_R+X1_MULTR_R+X1PAR1RAC
