...
# mean1 =apply(ECLSK1, 2, mean)
# mean2 =as.data.frame(apply(ECLSK2, 2, mean))
# mean3 =as.data.frame(apply(ECLSK3, 2, mean))
# mean4 =as.data.frame(apply(ECLSK4, 2, mean))
# mean5 =as.data.frame(apply(ECLSK5, 2, mean))

# sd1 = as.data.frame(apply(ECLSK1, 2, sd))
# sd2 = as.data.frame(apply(ECLSK2, 2, sd))
# sd3 = as.data.frame(apply(ECLSK3, 2, sd))
# sd4 = as.data.frame(apply(ECLSK4, 2, sd))
# sd5 = as.data.frame(apply(ECLSK5, 2, sd))
