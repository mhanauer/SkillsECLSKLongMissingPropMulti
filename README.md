...
$$ Level~2~Slope:~~~{\beta_{1j} = \gamma_{10} + \gamma_{11}Private_{j} + u_{1j}} ~~~ (1.3)$$

$$ Level~2~Slope:~~~{\beta_{x} = \gamma_{x0} + u_{xj}} ~~~ (1.4)$$

$$Mixed~model: ~~~{y_{ij} = \gamma_{00}+ \gamma_{0Q}(Q_{j}) + \gamma_{11}(Time_{ij})(Private_{j}) + \gamma_{x0}(X_{ij}) +u_{ij}(Time_{ij}) + u_{1j} + u_{xj} + u_{0j} + e_{ij}} ~~~(1.5)$$
