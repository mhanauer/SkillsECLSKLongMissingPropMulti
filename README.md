...
childEth = cbind(X1_RACETHP_R = data$X_RACETHP_R, X2_RACETHP_R = data$X_RACETHP_R, X3_RACETHP_R = data$X_RACETHP_R, X4_RACETHP_R = data$X_RACETHP_R)
...
childEth = cbind(X_HISP_R, X_BLACK_R, X_ASIAN_R, X_AMINAN_R, X_AMINAN_R, X_HAWPI_R, X_MULTR_R)
childEth = as.data.frame(childEth)
...
library(survey)
m = 5
a.out = amelia(x = data1, m=m, noms = c("X1PUBPRI", "X2PUBPRI", "X3PUBPRI", "X4PUBPRI", "X1_CHSEX_R", "X2_CHSEX_R", "X3_CHSEX_R", "X4_CHSEX_R", "X1_HISP_R", "X2_HISP_R", "X3_HISP_R", "X4_HISP_R", "X1_BLACK_R", "X2_BLACK_R", "X3_BLACK_R", "X4_BLACK_R", "X1_ASIAN_R", "X2_ASIAN_R", "X3_ASIAN_R", "X4_ASIAN_R", "X1_AMINAN_R", "X2_AMINAN_R", "X3_AMINAN_R", "X4_AMINAN_R", "X1_MULTR_R", "X2_MULTR_R", "X3_MULTR_R", "X4_MULTR_R", "X1PAR1RAC", "X2PAR1RAC", "X3PAR1RAC", "X4PAR1RAC"))
